...
const ServiceCard = ({service}) => {
    const {imageUrl, description, price, providerEmail, providerImage, providerName, serviceArea, serviceName} = service;
    return (
        <div>

            <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <img className="w-100 h-full" src={imageUrl} alt=""/>
